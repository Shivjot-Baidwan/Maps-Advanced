package shivjotbaidwan.maps_advanced;
...
/**
 * Created by shivjot.baidwan on 2/17/2017.
 */
...
public class MapFragment extends SupportMapFragment implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener,
    ...
    private void initCamera( Location location ) {
        ...
        getMap().setMapType( MAP_TYPES[currentMapTypeIndex] );
    ...
    private void drawCircle( LatLng location ) {
        ...
        options.fillColor( getResources()
                .getColor( R.color.marker_fill_color  ) );
        options.strokeColor( getResources()
                .getColor( R.color.marker_stroke_color ) );
